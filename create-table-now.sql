-- Script SQL simple pour créer la table consultation_messages
...
DROP POLICY IF EXISTS "Allow public to insert consultation messages" ON consultation_messages;
DROP POLICY IF EXISTS "Allow authenticated users to read consultation messages" ON consultation_messages;
DROP POLICY IF EXISTS "Allow authenticated users to update consultation messages" ON consultation_messages;
...
SELECT 'Table consultation_messages créée avec succès !' as message;
